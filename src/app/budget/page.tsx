...
interface GrantRule { id: string; name: string; fullName: string; maxBudget: number | null; subcontractLimit: number | null; salaryCapPerYear: number | null; fringeRate: number; indirectRate: number; indirectBase: 'MTDC' | 'TDC'; equipmentThreshold: number; notes: string[]; }
